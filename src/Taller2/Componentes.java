...
public class Componentes extends javax.swing.JFrame {
    ...
    private void arrastrarBoton(){
         jSlider1.addChangeListener(new ChangeListener() {
            @Override
            public void stateChanged(ChangeEvent e) {
              
                int sliderValue = jSlider1.getValue();
                jProgressBar1.setValue(sliderValue);
            }
        });   
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("CHECKBOX");

        jRadioButton1.setText("boton 1");

        jRadioButton2.setText("boton 2 ");

        jRadioButton3.setText("boton 3 ");

        jLabel2.setText("RADIO BUTTON");
        ...
        jList3.setModel(new javax.swing.AbstractListModel<String>() {
            String[] strings = { "Juan", "Jeronimo", "Jorge" };
            public int getSize() { return strings.length; }
            public String getElementAt(int i) { return strings[i]; }
        });
